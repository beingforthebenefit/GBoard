...
import { FractalField } from '../../components/FractalField.js'
...
export function FractalLayout({
  ...
  return (
    <div
      ...
      style={{ background: dark ? '#05060a' : '#efeae0' }}
    >
      <FractalField weather={weatherData} dark={dark} />
      ...
      <div className="absolute inset-0 z-10 flex flex-col p-6 gap-4">
        ...
        {/* Open center so the infinite zoom is the focus */}
