...
import { FractalLayout } from '../../layouts/fractal/FractalLayout.js'
...
describe('FractalLayout', () => {
  it('renders without crashing', () => {
    const { container } = render(<FractalLayout {...mockProps} />)
    expect(container.firstChild).toBeTruthy()
  })

  it('renders the zoom canvas behind the widgets', () => {
    const { container } = render(<FractalLayout {...mockProps} />)
    expect(container.querySelector('canvas')).toBeTruthy()
  })

  it('shows the clock time', () => {
    const { getByText } = render(<FractalLayout {...mockProps} />)
  ...
  it('shows now playing when a session is active', () => {
    ...
    const { getByText } = render(<FractalLayout {...mockProps} sessions={[session]} />)
