...
import { AuroraLayout } from '../../layouts/aurora/AuroraLayout.js'
...
describe('AuroraLayout', () => {
  it('renders without crashing', () => {
    const { container } = render(<AuroraLayout {...mockProps} />)
    expect(container.firstChild).toBeTruthy()
  })

  it('renders the color-field canvas behind the widgets', () => {
    const { container } = render(<AuroraLayout {...mockProps} />)
    expect(container.querySelector('canvas')).toBeTruthy()
  })

  it('shows the clock time', () => {
    const { getByText } = render(<AuroraLayout {...mockProps} />)
  ...
  it('shows now playing when a session is active', () => {
    ...
    const { getByText } = render(<AuroraLayout {...mockProps} sessions={[session]} />)
